...
- **Поточний етап**: Етап 8 — нормативні експорти за наказом № 440.
- **Гілка розробки**: `claude/equipment-tracking-system-3lB6U`
- **Найближчі дії**: Етап 9 (опційно) — інтеграції DELTA / «Кропива» /
  SAP / «Оберіг», або Етап 10 — безпека, аудит-лог, пілот.
- **Що вже є**:
