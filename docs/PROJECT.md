...
- **Поточний етап**: Етап 4 — місячна звітність + рейтинг експлуатантів.
- **Гілка розробки**: `claude/equipment-tracking-system-3lB6U`
- **Найближчі дії**: Етап 5 — AAR-кейси + auto-тригери (T1–T5),
  форма індивідуального звіту (6 блоків v1.0).
- **Що вже є**:
